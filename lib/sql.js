...
function connect(connectionInfo)
{
    return new Promise(function(resolve, reject)
    {
        pg.connect(connectionInfo, function(error, client, done)
        {
            ...
            resolve(conn.getTypes().return(conn));
...
Connection.prototype.getTypes = function()
{
    ...
    return new Promise(function(resolve, reject)
    {
        var queryDef = {text: "SELECT oid, typname FROM pg_type WHERE typtype = 'b' ORDER BY oid"};
        ...
        {
            logger.error("Connection#getTypes got error: %s", error.stack || error);
        ...
        function onRow(row)
        {
            self.types[row.oid] = row.typname;
        } // end onRow
